<template>
  ...
  <view class='answer-footer flex-wrp'>
    <view class='good flex-item'>
        <view class='good-bad'>
            <image src='../../asset/images/good-bad.png'></image>
        </view>
    ...
    <view class='operation-wrp flex-item'>
      <view class='operation flex-wrp flex-tab'>
        <view class='operation-btn flex-item'>
          <image src='../../asset/images/flag.png'></image>
          <text>没有帮助</text>
        </view>
        <view class='operation-btn flex-item'>
          <image src='../../asset/images/heart2.png'></image>
          <text>感谢</text>
        </view>
        <view class='operation-btn flex-item'>
          <image src='../../asset/images/star2.png'></image>
          <text>收藏</text>
        </view>
        <view class='operation-btn flex-item'>
          <image src='../../asset/images/comment.png'></image>
          <text>302</text>
        </view>
      </view>
    </view>
